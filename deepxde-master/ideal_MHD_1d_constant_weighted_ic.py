...
ic1l = dde.ConstantWeightDirichletBC(geom, lambda x: np.ones((len(x),1)), boundary_time_left, component=0)
ic2l = dde.ConstantWeightDirichletBC(geom, lambda x: np.zeros((len(x),1)), boundary_time_left, component=1)
ic3l = dde.ConstantWeightDirichletBC(geom, lambda x: np.zeros((len(x),1)), boundary_time_left, component=2)
ic4l = dde.ConstantWeightDirichletBC(geom, lambda x: np.zeros((len(x),1)), boundary_time_left, component=3)
ic5l = dde.ConstantWeightDirichletBC(geom, lambda x: np.ones((len(x),1)), boundary_time_left, component=4)
ic6l = dde.ConstantWeightDirichletBC(geom, lambda x: np.zeros((len(x),1)), boundary_time_left, component=5)
ic7l = dde.ConstantWeightDirichletBC(geom, lambda x: np.ones((len(x),1)), boundary_time_left, component=6)
ic1r = dde.ConstantWeightDirichletBC(geom, lambda x: 0.125*np.ones((len(x),1)), boundary_time_right, component=0)
ic2r = dde.ConstantWeightDirichletBC(geom, lambda x: np.zeros((len(x),1)), boundary_time_right, component=1)
ic3r = dde.ConstantWeightDirichletBC(geom, lambda x: np.zeros((len(x),1)), boundary_time_right, component=2)
ic4r = dde.ConstantWeightDirichletBC(geom, lambda x: np.zeros((len(x),1)), boundary_time_right, component=3)
ic5r = dde.ConstantWeightDirichletBC(geom, lambda x: -1*np.ones((len(x),1)), boundary_time_right, component=4)
ic6r = dde.ConstantWeightDirichletBC(geom, lambda x: np.zeros((len(x),1)), boundary_time_right, component=5)
ic7r = dde.ConstantWeightDirichletBC(geom, lambda x: 0.1*np.ones((len(x),1)), boundary_time_right, component=6)
